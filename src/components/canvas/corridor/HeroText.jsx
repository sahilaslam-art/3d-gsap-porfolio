 ...
 * - SArt in Rubik Scribble font (splits into letters during scroll)
...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for SArt split effect
    const letters = useMemo(() => [
        { char: 'S', baseX: -0.95, splitDir: -1.6, delay: 0 },
        { char: 'A', baseX: -0.43, splitDir: -0.6, delay: 0 },
        { char: 'r', baseX: 0.23, splitDir: 0.6, delay: 0 },
        { char: 't', baseX: 0.95, splitDir: 1.8, delay: 0 },
    ], []);
    ...
    useFrame((state, delta) => {
        ...
        // Apply split to each letter of SArt
    ...
    return (
        <group ref={groupRef} position={position} scale={[scale, scale, 1]}>
            {/* SArt Letters - Rubik Scribble font with fade-in animation */}
