...
const MonitorBlock = memo(({ item, meshRef, isSelected, onMonitorClick, disabled, paintOnBeforeCompile, paintUniforms }) => {
    ...
    const isBlogMonitor = item.platform === 'linkedin';
    const isTvMonitor = item.platform === 'github';
    const isPhoneMonitor = item.platform === 'instagram';
    ...
    // Load Phone textures (Instagram) - shell + painted
